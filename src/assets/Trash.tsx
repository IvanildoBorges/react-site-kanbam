export default function Trash({...props}) {
    ...
    const corDaTampa: string = props.corDaTampa;
    const corDaLata: string = props.corDaLata;
    const corDasListras: string = props.corDasListras;
    const tamanho: number = props.tamanho;
    const onTapTrash: () => void = props.onTapTrash;
